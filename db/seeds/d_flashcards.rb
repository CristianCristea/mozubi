...
@flashcard36 = Flashcard.create!(article: @topic7_article1, content: "Why do developers never comment their code?")
Answer.create!(flashcard: @flashcard36, content: "Because they don't know how to do that.")
Answer.create!(flashcard: @flashcard36, content: "Because no code is better than no code.")
Answer.create!(flashcard: @flashcard36, content: "Because if it was hard to write then it must be hard to read!", right_answer: true)
Answer.create!(flashcard: @flashcard36, content: "Because it the rubocop will complain about it.")

@flashcard37 = Flashcard.create!(article: @topic7_article2, content: "Why do developers never comment their code?")
Answer.create!(flashcard: @flashcard37, content: "Because they don't know how to do that.")
Answer.create!(flashcard: @flashcard37, content: "Because no code is better than no code.")
Answer.create!(flashcard: @flashcard37, content: "Because if it was hard to write then it must be hard to read!", right_answer: true)
Answer.create!(flashcard: @flashcard37, content: "Because it the rubocop will complain about it.")

@flashcard38 = Flashcard.create!(article: @topic7_article3, content: "Why do developers never comment their code?")
Answer.create!(flashcard: @flashcard38, content: "Because they don't know how to do that.")
Answer.create!(flashcard: @flashcard38, content: "Because no code is better than no code.")
Answer.create!(flashcard: @flashcard38, content: "Because if it was hard to write then it must be hard to read!", right_answer: true)
Answer.create!(flashcard: @flashcard38, content: "Because it the rubocop will complain about it.")

@flashcard39 = Flashcard.create!(article: @topic7_article4, content: "Why do developers never comment their code?")
Answer.create!(flashcard: @flashcard39, content: "Because they don't know how to do that.")
Answer.create!(flashcard: @flashcard39, content: "Because no code is better than no code.")
Answer.create!(flashcard: @flashcard39, content: "Because if it was hard to write then it must be hard to read!", right_answer: true)
Answer.create!(flashcard: @flashcard39, content: "Because it the rubocop will complain about it.")

@flashcard40 = Flashcard.create!(article: @topic7_article5, content: "Why do developers never comment their code?")
Answer.create!(flashcard: @flashcard40, content: "Because they don't know how to do that.")
Answer.create!(flashcard: @flashcard40, content: "Because no code is better than no code.")
Answer.create!(flashcard: @flashcard40, content: "Because if it was hard to write then it must be hard to read!", right_answer: true)
Answer.create!(flashcard: @flashcard40, content: "Because it the rubocop will complain about it.")

@flashcard41 = Flashcard.create!(article: @topic7_article6, content: "Why do developers never comment their code?")
Answer.create!(flashcard: @flashcard41, content: "Because they don't know how to do that.")
Answer.create!(flashcard: @flashcard41, content: "Because no code is better than no code.")
Answer.create!(flashcard: @flashcard41, content: "Because if it was hard to write then it must be hard to read!", right_answer: true)
Answer.create!(flashcard: @flashcard41, content: "Because it the rubocop will complain about it.")

@flashcard42 = Flashcard.create!(article: @topic7_article6, content: "Why do developers never comment their code?")
Answer.create!(flashcard: @flashcard42, content: "Because they don't know how to do that.")
Answer.create!(flashcard: @flashcard42, content: "Because no code is better than no code.")
Answer.create!(flashcard: @flashcard42, content: "Because if it was hard to write then it must be hard to read!", right_answer: true)
Answer.create!(flashcard: @flashcard42, content: "Because it the rubocop will complain about it.")

@flashcard43 = Flashcard.create!(article: @topic7_article6, content: "Why do developers never comment their code?")
Answer.create!(flashcard: @flashcard43, content: "Because they don't know how to do that.")
Answer.create!(flashcard: @flashcard43, content: "Because no code is better than no code.")
Answer.create!(flashcard: @flashcard43, content: "Because if it was hard to write then it must be hard to read!", right_answer: true)
Answer.create!(flashcard: @flashcard43, content: "Because it the rubocop will complain about it.")

@flashcard44 = Flashcard.create!(article: @topic7_article6, content: "Why do developers never comment their code?")
Answer.create!(flashcard: @flashcard44, content: "Because they don't know how to do that.")
Answer.create!(flashcard: @flashcard44, content: "Because no code is better than no code.")
Answer.create!(flashcard: @flashcard44, content: "Because if it was hard to write then it must be hard to read!", right_answer: true)
Answer.create!(flashcard: @flashcard44, content: "Because it the rubocop will complain about it.")

# ---------------------------- TOPIC 8 ----------------------------

@flashcard45 = Flashcard.create!(article: @topic8_article1, content: "Why do developers never comment their code?")
Answer.create!(flashcard: @flashcard45, content: "Because they don't know how to do that.")
Answer.create!(flashcard: @flashcard45, content: "Because no code is better than no code.")
Answer.create!(flashcard: @flashcard45, content: "Because if it was hard to write then it must be hard to read!", right_answer: true)
Answer.create!(flashcard: @flashcard45, content: "Because it the rubocop will complain about it.")

@flashcard46 = Flashcard.create!(article: @topic8_article2, content: "Why do developers never comment their code?")
Answer.create!(flashcard: @flashcard46, content: "Because they don't know how to do that.")
Answer.create!(flashcard: @flashcard46, content: "Because no code is better than no code.")
Answer.create!(flashcard: @flashcard46, content: "Because if it was hard to write then it must be hard to read!", right_answer: true)
Answer.create!(flashcard: @flashcard46, content: "Because it the rubocop will complain about it.")

@flashcard47 = Flashcard.create!(article: @topic8_article3, content: "Why do developers never comment their code?")
Answer.create!(flashcard: @flashcard47, content: "Because they don't know how to do that.")
Answer.create!(flashcard: @flashcard47, content: "Because no code is better than no code.")
Answer.create!(flashcard: @flashcard47, content: "Because if it was hard to write then it must be hard to read!", right_answer: true)
Answer.create!(flashcard: @flashcard47, content: "Because it the rubocop will complain about it.")
